...
int main()
{
    ...
    do
    {
        ...
        {
        case 1:
            count++;    ///increment the count because we are adding an element
            ...
            cout << "Elements in the list: "<< count << endl << endl;
            break;
        case 2:
        ...
        case 4:
            ...
            remove(p,n,count);
            count--;
            size /= 2;  ///because it will unconditionally be mul by two by each call to expand
            p = expand(p, count, size); ///and we don't want to grow on a removal
            cout << endl;
            printList(p, count);///debugging and status info
            cout << "Elements in the list: "<< count << endl << endl;
            break;
