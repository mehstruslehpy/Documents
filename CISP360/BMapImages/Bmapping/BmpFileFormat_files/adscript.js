...
function DisplayFCAdBanner() {
		...
		if(FCWindowWidth >= 730) {
			...
			document.write('<script language="Javascript" src="http://web.archive.org/web/20080912034156/http://oascentral.fortunecity.com/RealMedia/ads/adstream_jx.ads/FC/' + fcadunit + '@Top2!Top2"></script>');
			...
			document.write('<script language="Javascript" src="http://web.archive.org/web/20080912034156/http://oascentral.fortunecity.com/RealMedia/ads/adstream_jx.ads/FC/' + fcadunit + '@Top!Top"></script>');
...
function DisplayFCAdButtons() {
	...
	if(fcadunit != 'adult') {
		...
		if(FCWindowWidth > 700) {
			...
			document.write('<script type="text/javascript" src="http://web.archive.org/web/20080912034156/http://pagead2.googlesyndication.com/pagead/show_ads.js"></script>');
		}
...
// then do the normal prepend:
			...
			document.links[i].href = 'http://web.archive.org/web/20080912034156/http://www' + this_domain + '/banners/interstitial.html?' + document.links[i].href;
...
function spawntopfivewindow() {
	...
	if (showpopup == 1 && FCWindowWidth > 400 && IsFCMember() == 0 && document.cookie.indexOf('fcseeninter') == -1 && fcadunit != 'adult') {
		...
		window.open('http://web.archive.org/web/20080912034156/http://www.fortunecity.com/banners/exit.html','top5popup','toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,width=820,height=610,left=0,top=0,screenX=0,screenY=0');
...
/*
     FILE ARCHIVED ON 03:41:56 Sep 12, 2008 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 17:30:12 Apr 09, 2017.
