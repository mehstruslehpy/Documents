...
void lenv_add_builtins(lenv* e) {
  ...
  /* My functions*/
  lenv_add_builtin(e, "!",  builtin_not); lenv_add_builtin(e, "!",   builtin_not);
  lenv_add_builtin(e, "||",  builtin_or); lenv_add_builtin(e, "||",   builtin_or);
  lenv_add_builtin(e, "&&",  builtin_and); lenv_add_builtin(e, "&&",   builtin_and);
}
...
int main(int argc, char** argv) {
  ...
  mpca_lang(MPCA_LANG_DEFAULT,
    "                                                     \
      ...
      sexpr  : '(' <expr>* ')' ;                          \
      qexpr  : '{' <expr>* '}' ;                          \
      expr   : <bool> | <number> | <symbol> | <sexpr> | <qexpr> ;  \
      lispy  : /^/ <expr>* /$/ ;                          \
    ",
    Bool, Number, Symbol, Sexpr, Qexpr, Expr, Lispy);
  ...
  mpc_cleanup(6, Bool, Number, Symbol, Sexpr, Qexpr, Expr, Lispy);
