...
(defparameter *allowed-commands* '(look-around walk charge new-game help quit clear-screen view-known-map))
...
(defun game-print (lst)
	(princ (coerce (tweak-text (coerce (string-trim "() "
								...
								nil)
					'string))
	(fresh-line)(princ "CMD>"))


;;;clear the window, print a opening message then begin the game
(screen:clear-window (screen:make-window))
(princ "Welcome to Hunt The Wumpus v0.1" (fresh-line))
(princ "                        "(fresh-line))
(princ "    ####        ####    "(fresh-line))
(princ "    ####        ####    "(fresh-line))
(princ "    ####        ####    "(fresh-line))
...
(fresh-line)
(princ "Welcome to Hunt The Wumpus. You are lost in the seedy underbelly of a sprawling metropolitan city. You must hunt down and kill the dastardly Wumpus.")
(fresh-line)
(look-around)
(princ "CMD>")
(game-repl)
