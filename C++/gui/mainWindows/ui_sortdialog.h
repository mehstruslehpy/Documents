...
public:
    ...
    void setupUi(QDialog *SortDialog)
    {
        ...
        primaryGroupBox->setMinimumSize(QSize(0, 104));
        primaryGroupBox->setMaximumSize(QSize(16777215, 104));
        ...
        gridLayout_4->addWidget(primaryGroupBox, 0, 0, 1, 1, Qt::AlignHCenter);
        ...
        verticalSpacer = new QSpacerItem(5, 20, QSizePolicy::Minimum, QSizePolicy::Fixed);
        ...
        moreButton->setAutoRepeat(false);
        moreButton->setAutoExclusive(false);
        moreButton->setAutoDefault(false);
        moreButton->setDefault(false);
        moreButton->setFlat(false);

        verticalLayout_2->addWidget(moreButton);
        ...
        verticalSpacer_3 = new QSpacerItem(5, 20, QSizePolicy::Minimum, QSizePolicy::Fixed);

        gridLayout_4->addItem(verticalSpacer_3, 1, 0, 1, 2);

        QWidget::setTabOrder(tertiaryOrderCombo, tertiaryColumnCombo);
        QWidget::setTabOrder(tertiaryColumnCombo, secondaryOrderCombo);
        QWidget::setTabOrder(secondaryOrderCombo, secondaryColumnCombo);
        QWidget::setTabOrder(secondaryColumnCombo, PrimaryOrderCombo);
        QWidget::setTabOrder(PrimaryOrderCombo, primaryColumnCombo);
    ...
    void retranslateUi(QDialog *SortDialog)
    {
        ...
        label->setText(QApplication::translate("SortDialog", "Order:", 0, QApplication::UnicodeUTF8));
