...
static unsigned int bytesOnLine(string str)
{
	if (str.find("addi")!=string::npos)
		return 2;
	else if (str.find("jmpi")!=string::npos)
		return 2;
	else if (str.find("jci")!=string::npos)
		return 2;
	else if (str.find("jzi")!=string::npos)
		return 2;
	else if (str.find("jsi")!=string::npos)
		return 2;
	else if (str.find("joi")!=string::npos)
		return 2;
	else if (str.find("jli")!=string::npos)
		return 2;
	else if (str.find("ldi")!=string::npos)
		return 2;
	else if (str.find("jmp")!=string::npos)
		return 1;
	else if (str.find("jc")!=string::npos)
		return 1;
	else if (str.find("jz")!=string::npos)
		return 1;
	else if (str.find("js")!=string::npos)
		return 1;
	else if (str.find("jo")!=string::npos)
		return 1;
		...
		return 1;
	else if (str.find("ld")!=string::npos)
		return 1;
